<template>	
	<el-tabs type="border-card" @tab-click="changeTab">
		<el-tab-pane label="企业">
			<componentPageCom ref='pageCom' :menuIndex='3' :role='role' :level='2' :status='status' :start='startType' :reviewButton='reviewButton' :reviewLogButton='reviewLogButton' @chakan='look' @shenheLog='verifyLog'></componentPageCom>
		...
		<el-tab-pane label="个人">
			<componentPagePer ref='pagePer' :menuIndex='3' :role='role' :level='1' :status='status' :start='startType' :reviewButton='reviewButton' :reviewLogButton='reviewLogButton' @chakan='lookPer'  @shenheLog='verifyLogPer'></componentPagePer>
