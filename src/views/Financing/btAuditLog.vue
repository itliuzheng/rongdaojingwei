			...
			<el-row :gutter="20">
				...
				<el-col :span="device === 'desktop'?'4':'12'">
					<el-select v-model="filterData.industry" placeholder="所属行业/职业">
						<el-option v-for="item in job.industry" :key="item.id" :label="item.name" :value="item.name">
						</el-option>
					</el-select>
				</el-col>
				<el-col :span="device === 'desktop'?'4':'12'">
					...
					<el-row :gutter="20">
						...
						<el-col :span="device === 'desktop'?'12':'24'">
							<el-form-item label="所属行业">
								<el-input v-model="formDataCom.industry" disabled></el-input>
					...
					<el-row :gutter="20">
						...
						<el-col :span="device === 'desktop'?'12':'24'">
							<el-form-item label="职业">
								<el-input  v-model="formDataPer.industry" disabled></el-input>
